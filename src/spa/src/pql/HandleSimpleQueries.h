...
public:
    ...
    static void handleProcedureSelectType(string selectVar,const string& conditionType, bool isT, const string& leftArg, const string& rightArg, vector<string>& databaseResults, Query& queryToExecute);
